...
SELECT pg_catalog.setval('public.logged_id_seq', 1, false);
...
--
-- Name: logged logged_email_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.logged
    ADD CONSTRAINT logged_email_key UNIQUE (email);
...
--
-- Name: urls urls_user_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.urls
    ADD CONSTRAINT urls_user_fkey FOREIGN KEY ("user") REFERENCES public.users(id);
